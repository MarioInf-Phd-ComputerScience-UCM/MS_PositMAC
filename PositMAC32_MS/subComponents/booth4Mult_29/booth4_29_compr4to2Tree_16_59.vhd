...
entity booth4_29_compr4to2Tree_16_59 is
	port(
...
end booth4_29_compr4to2Tree_16_59;

architecture estr of booth4_29_compr4to2Tree_16_59 is

	--Components

	component booth4_29_compr4to2 is
		generic(
			N: integer
		);
		port(
	...
	signal shMatrix_1_1: std_logic_vector(58 downto 0);
	signal shMatrix_1_3: std_logic_vector(58 downto 0);
	signal shMatrix_1_5: std_logic_vector(58 downto 0);
	signal shMatrix_1_7: std_logic_vector(58 downto 0);
	signal shMatrix_2_1: std_logic_vector(58 downto 0);
	signal shMatrix_2_3: std_logic_vector(58 downto 0);
	signal shMatrix_3_1: std_logic_vector(58 downto 0);
...
entity booth4_29_compr4to2Tree_16_59_tb is
	port(
		x0: in std_logic_vector(58 downto 0);
		x1: in std_logic_vector(58 downto 0);
		x2: in std_logic_vector(58 downto 0);
		...
		x14: in std_logic_vector(58 downto 0);
		x15: in std_logic_vector(58 downto 0);
		z: out std_logic_vector(58 downto 0);
		cout: out std_logic
	);
end booth4_29_compr4to2Tree_16_59_tb;

architecture tb of booth4_29_compr4to2Tree_16_59_tb is
	...
	signal s: std_logic_vector(58 downto 0);
	signal c: std_logic_vector(58 downto 0);
	signal ns: std_logic_vector(59 downto 0);
	signal nc: std_logic_vector(59 downto 0);
	signal nz: std_logic_vector(59 downto 0);

begin

	tree: booth4_29_compr4to2Tree_16_59 port map(x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,s,c);
	...
	cin_ks <= '0';
	ks: 	cin_ks <= '0';
	ks_ks: kogge_stone generic map(60,6)
