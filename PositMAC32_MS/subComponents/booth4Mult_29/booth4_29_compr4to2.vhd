...
--This module implements a [4:2] compressor unit

entity booth4_29_compr4to2 is
  generic(
    N: integer
  );
	port(
...
end booth4_29_compr4to2;

architecture estr of booth4_29_compr4to2 is

  --Components
  component booth4_29_compr4to2Simple is
	 port(
	  q0: in std_logic;
		q1: in std_logic;
		q2: in std_logic;
...
begin
  ...
  for i in 0 to (N-1) generate
    celli: booth4_29_compr4to2Simple port map(q0(i),q1(i),q2(i),q3(i),cs(i),
              r0(i),r1(i),cs(i+1));
