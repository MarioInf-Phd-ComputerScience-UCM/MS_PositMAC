--------------------------------------------------------------------------------
--                   RightShifter296_by_max_240_F50_uid124_old
...
entity RightShifter296_by_max_240_F50_uid124_old is
    port (clk     : in std_logic;
          X       : in  std_logic_vector(295 downto 0);
          S       : in  std_logic_vector(7 downto 0);
          padBit  : in  std_logic;
          R       : out  std_logic_vector(295 downto 0)   );
end entity RightShifter296_by_max_240_F50_uid124_old;


architecture arch of RightShifter296_by_max_240_F50_uid124_old is
...
begin
   ...
   concat_val6   <= (others => padBit_d1);
   concat_val7   <= (others => padBit_d1);
   concat_val8   <= (others => padBit_d1);
   ...
   level4 <=  concat_val4 & level3_d1     when ps_d1(3) = '1'  else    level3_d1 & concat0_val4;
   level5 <=  concat_val5 & level4        when ps_d1(4) = '1'  else    level4 & concat0_val5;
   level6 <=  concat_val6 & level5        when ps_d1(5) = '1'  else    level5 & concat0_val6;
   level7 <=  concat_val7 & level6        when ps_d1(6) = '1'  else    level6 & concat0_val7;
   level8 <=  concat_val8 & level7        when ps_d1(7) = '1'  else    level7 & concat0_val8;
